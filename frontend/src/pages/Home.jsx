 ...
 const handleSaveMetadata = async (metadata) => {
  try {
   ...
   if (data.success) {
    ...
    // setIsEditingMetadata(false); // No longer needed, modal handles its own state
   }
  } catch (error) {
   ...
   {book.pages && (
    <div className="w-full overflow-x-hidden">
     <Book
      ...
      bookId={bookId} // Pass bookId as prop
      bookTitle={book.title} // Pass bookTitle as prop
      bookCoverPage={book.coverPage} // Pass bookCoverPage as prop
      bookEndCoverPage={book.endCoverPage} // Pass bookEndCoverPage as prop
      handleSaveMetadataFromBook={handleSaveMetadata} // Pass handleSaveMetadata as prop, rename it for clarity
     />
    </div>
   )}
  </div>
